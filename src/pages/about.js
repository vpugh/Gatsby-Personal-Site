...
const AboutPage = () => (
  <Layout>
    <SEO title="UI/UX Developer" />
      ...
      <blockquote>I listen to understand a problem, do research to identify and/or confirm it, and then create solutions for them.</blockquote>
      <div style={{ display: 'flex' }}>
        <div className="text-holder">
          ...
          <p>
I share and interact on <a class="inline-link" href="https://twitter.com/teekatwo" rel="noopener noreferrer" target="_blank">Twitter</a>; get inspired and showcase work on <a class="inline-link" href="https://dribbble.com/teekatwo" rel="noopener noreferrer" target="_blank">Dribbble</a>; tinker and learn new code on <a class="inline-link" href="https://codepen.io/Vpugh/" rel="noopener noreferrer" target="_blank">Codepen</a>; work on side projects on <a class="inline-link" href="https://github.com/vpugh" rel="noopener noreferrer" target="_blank">Github</a>; and write when I can on <a class="inline-link" href="https://medium.com/@teekatwo" rel="noopener noreferrer" target="_blank">Medium</a> or <a class="inline-link" href="https://dev.to/teekatwo" rel="noopener noreferrer" target="_blank">Dev.to</a>. In my free time, I'm an avid reader with a ever-growing backlog of books or trying to get through my game collection for the PS4 (Red Dead Redemption 2, AC Odyssey, Tomb Raider).
</p>

          <p>
I've had two speaking engagements at <a class="inline-link" href="https://www.youtube.com/watch?v=xHpZzXvwjwM&amp;list=PLyLTyCCJDTTe5Ay6yOqiBW8KgZyKXRI5U&amp;index=14" rel="noopener noreferrer" target="_blank">Codeland 2018</a> and <a class="inline-link" href="https://wordpress.tv/2018/12/05/tori-pugh-the-importance-of-typography-design-usability-cost-and-loading-times/" rel="noopener noreferrer" target="_blank">WordCamp Philly 2018</a>.
</p>
        </div>
