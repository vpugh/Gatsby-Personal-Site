...
import { SocialMediaContainer } from '../styles/social-media-styled';
...
const SocialMedia = ({ iconWidth }) => {
  return (
    <SocialMediaContainer>
      ...
      <li className="soc">
        <a href="https://codepen.io/Vpugh/" rel="noopener noreferrer" target="_blank" title="Codepen">
          <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid slice" width={iconWidth}>
      ...
      <li className="soc">
        <a href="https://dribbble.com/teekatwo" rel="noopener noreferrer" target="_blank" title="Dribbble">
          <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid slice" width={iconWidth}>
      ...
      <li className="soc">
        <a href="https://github.com/vpugh" rel="noopener noreferrer" target="_blank" title="GitHub">
          <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid slice" width={iconWidth}>
      ...
      <li className="soc">
        <a href="https://www.instagram.com/toripugh/" rel="noopener noreferrer" target="_blank" title="Instagram">
          <svg viewBox="0 0 512 512" preserveAspectRatio="xMidYMid slice" width={iconWidth}>
